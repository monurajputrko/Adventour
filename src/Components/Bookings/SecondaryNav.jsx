...
const SecondaryNav = () => {
  ...
  return (
  <C.Flex p={{base:"15px",lg:"20px 5rem"}} display={{base:"none",lg:"flex"}} position={{base:"fixed"}} zIndex="20" color={'white'} bg="cyan.100" gap="1em" alignItems="center" h={{base:"100vh",lg:"120px"}} w={{base:"20vw",lg:"100vw"}} flexDirection={{base:"column",lg:"row"}}>
    <C.FormControl>
