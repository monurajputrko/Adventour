      ...
      <Modal blockScrollOnMount={false} isOpen={isOpen} onClose={onClose}>
        ...
        >
          ...
          <ModalBody >
            ...
            <Divider />
            <Box w={'80%'} m={'auto'}>
              <Button w={'100%'} my={5} outline={'0.5px solid black'} px={10} py={3} onClick={handleGoogleLogin} size="large" color="inherit" variant="outlined">
                <Iconify icon="eva:google-fill" color="#DF3E30" width={22} height={22} />
                <Spacer />
                <Text fontWeight={700} fontSize={'20'}>Login with Google</Text>
              </Button>
            </Box>
          </ModalBody>
        </ModalContent>
